...
class PoseClassifier(object):
  ...
  def __call__(self, pose_landmarks):
    ...
    return result      # Sample is an outlier if nearest poses have different class or more than
...
class PoseClassificationVisualizer(object):
  ...
  def __init__(self,
               class_name,
               plot_location_x=0.02,
               plot_location_y=0.02,
               plot_max_width=0.3,
               plot_max_height=0.3,
               plot_figsize=(5, 3),
               plot_x_max=None,
...
###
st.subheader('Rehabilitation exercise monitoring')
#Measure the time
...
if uploaded_file is not None:
    ...
    if output_frame is not None:
       st.image(output_frame)
       st.subheader("The corrected exercise is {}".format(repetitions_count))
